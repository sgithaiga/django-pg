# Generated by Django 3.1.2 on 2022-09-04 10:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('transport', '0036_auto_20220904_0958'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='transport.driver')),
                ...
                ('fuel_type_requested', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='xnfueltype', to='transport.vendor_fuel_types')),
                ('price_per_liter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='xnfuelprice', to='transport.vendor_price')),
